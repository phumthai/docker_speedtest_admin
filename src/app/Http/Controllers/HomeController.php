...
class HomeController extends Controller
{
    public function index(Request $request) 
    {
        ...
        $data = DB::table('speedtest_users')->select(DB::raw('date(timestampss) as tt, count(*) as co'))->groupBy('tt')->get();

        $table = DB::table('speedtest_users')->select(DB::raw('timestampss,ip,userid,dl,ul,ping,subnet,apname'))->paginate(8);
        
        $subnet = DB::table('speedtest_users')->select(DB::raw('subnet, count(*) as co'))->groupBy('subnet')->orderBy('co','desc')->take(10)->get();

        $apname = DB::table('speedtest_users')->select(DB::raw('apname, count(*) as co'))->where('apname','!=','No AP data')->groupBy('apname')->orderBy('co','desc')->take(10)->get();
        ...
        $AC = DB::table('speedtest_users')->select(DB::raw('count(*) as ac'))->where('subnet','=','Jumbo wifi')->get();
        ...
        $MXC = DB::table('speedtest_users')->select(DB::raw('count(*) as mxc'))->where('subnet','=','Jumbo wifi')->get();
        ...
        $MNC = DB::table('speedtest_users')->select(DB::raw('count(*) as mnc'))->where('subnet','=','Jumbo wifi')->get();
        ...
        $SDC = DB::table('speedtest_users')->select(DB::raw('count(*) as sdc'))->where('subnet','=','Jumbo wifi')->get();
