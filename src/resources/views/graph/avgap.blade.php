...
<html>
    <head>
        <title>Speedtest Average by AP</title>
...
<body>
    ...
    <div class="container">
    @auth
        <h3 align="center">Average by AP</h3><br />
        <div class="row">
            <div class="col-md-9">
...
<script>
    $(document).ready(function(){
        ...
        {
            $.ajax({
            url:"/avgap/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
